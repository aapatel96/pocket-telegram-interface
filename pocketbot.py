...
filtersKeyboard = InlineKeyboardMarkup([[InlineKeyboardButton("state", callback_data='state'),InlineKeyboardButton("tags", callback_data='tags')],
                                        [InlineKeyboardButton("content type", callback_data='content type'),InlineKeyboardButton("sort by", callback_data='sort')],
                                        [InlineKeyboardButton("apply filters", callback_data='apply')],[InlineKeyboardButton("reset", callback_data='reset')]])
stateKeyboard = InlineKeyboardMarkup([[InlineKeyboardButton("unread", callback_data='unread')],[InlineKeyboardButton("archive", callback_data='archive')]])
...
class User:
    def __init__(self,user_id):
        ...
        self.filters = {"state":None,"favorite":None,"tag":None,"contentType":None,
...
def menuButtons(bot,update):
    ...
    if str(queryData) == "filter":
        ...
        bot.edit_message_reply_markup(chat_id =queryObj.message.chat_id,message_id=mid,reply_markup =filtersKeyboard,parse_mode='HTML')
        return
